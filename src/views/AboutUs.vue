      ...
      planetCard: [
        {
          ...
          img3: '~@/assets/image/aboutus/mars03.svg',
          img4: '~@/assets/image/aboutus/mars04.svg',
          title2: '尋找生命之旅',
          note2: '你與我的起源',
        ...
        },
        {
          ...
          img3: '~@/assets/image/aboutus/moon03.svg',
          img4: '~@/assets/image/aboutus/moon04.svg',
          title2: '太空之心',
          note2: '月球七天六夜奇幻之旅',
        ...
        },
        {
          ...
          ch_name: '金星',
          img1: '~@/assets/image/aboutus/venus01.svg',
          img2: '~@/assets/image/aboutus/venus02.svg',
          title1: '人文遺跡之旅',
          note1: '知識解謎探索',
          info1: '沉浸於麥田圈迷宮的神秘符號，融入蜥蜴人社區，學習語言、文化，共享美食，追隨遺跡，穿越城市廢墟，發現寶藏，探索過去文明，挑戰銀河砂流，感受宇宙冒險。',
          img3: '~@/assets/image/aboutus/venus03.svg',
          img4: '~@/assets/image/aboutus/venus04.svg',
          title2: '金星夢幻秘境',
          note2: '地脈探索',
