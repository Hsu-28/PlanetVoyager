  ...
  <section class="introduce-container">
    <div class="introduce">
      ...
      <div class="introduce-p" v-show="show1">
        ...
        <p>由地球出發 一天的航程後，我們將會在第二天登陸月球，朝聖人類的星際里程碑--阿姆斯壯的腳印，之後會遊歷月球上最大的隕石坑---貝利環形山、在滿月海中馳騁、橫越東月大裂谷、參觀台日共構的月球基地，飽覽月球風光後再返回地球。
        </p>
      </div>
      ...
      <ul class="travelInfo">
        ...
        <li>
          ...
          <div class="itemp"><strong>行前訓練</strong><br>您須於旅程三個月前參與為期一週的訓練，並於結訓時接受評估，若行前訓練評估未通過則退費70% 。欲了解行前訓練內容，請
            <router-link to="training">點擊此處 </router-link>。</div>
...
<style scoped lang="scss">@import "~@/assets/sass/page/orderProcess.scss";</style>
