                    ...
                    <table>
                        <tbody>
                            <tr v-for="(news, number) in news" :key="number" :class="{ 'active': activeId === news.id }">
                                <td @click="activeId = news.id">{{ news.title }}</td>
                                <td @click="activeId = news.id">{{ news.date }}</td>
                            </tr>
                        </tbody>
                    </table>
        ...
        return {
            ...
            news: [
                ...
                },
                {
                    ...
                    title: '火星殖民：人類的下一步',
                    date: '2023-04-20',
                    info: '自從人類首次觀望星空以來，我們就一直夢想著遠足於其他星球。近年來，隨著科技的進步和太空探索的蓬勃發展，火星殖民的話題已經引起了大家的廣泛關注。但是，火星上的生活真的可能嗎？火星，被稱為:紅色星球，與地球有著許多相似之處。它的白天和夜晚的長度與地球相近，而且其季節的變化也與我們的藍色星球類似。但這只是表面的相似。火星的大氣主要由二氧化碳組成，氣候寒冷，表面充滿了沙塵暴，這些都使得火星的生存環境非常嚴酷。儘管有這些挑戰，但科學家和工程師已經開始計劃如何在火星上建立殖民地。透過先進的太空技術，例如生命維持系統和居住艙，我們可以在火星上建立一個封閉的生態環境。此外，火星的地下水冰資源也為我們提供了飲用水和生產氧氣的可能性。目前，許多私人企業和國家太空機構都已經展開了火星探索任務。它們的目標不僅是尋找火星上的生命跡象，更重要的是為未來的火星殖民做好準備。總的來說，火星殖民是人類太空探索的重要里程碑。雖然挑戰重重，但隨著科技的發展，這一夢想將不再遙不可及。',
                    img: require("@/assets/image/index/ship.svg"),
                },
                {
                    id:'3',
