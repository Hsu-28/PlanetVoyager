<template>
  <div class="firstM">
    <img src="@/assets/image/orderProcess/Mars.png" alt="">
  </div>
  <div class="title">
    <h1>火星體驗之旅</h1>
    <h2>Mars Exploration Journey</h2>
  </div>
  ...
  <section class="confirm-Order" v-if="orderCheck">
    <div class="confirm-contain">
      ...
      <div class="order-finall">
        ...
        <div class="order-finall-btn btn-Check">確認訂購</div>
      </div>
...
<script src="@/views/js/orderProcessMars.js"></script>
