<template>
  <div class="firstM">
    <img src="@/assets/image/orderProcess/venus.png" alt="">
  </div>
  <div class="title">
    <h1>金星體驗之旅</h1>
    <h2>Venus Exploration Journey</h2>
  </div>
  ...
  <section class="passengerInfo">
    ...
    <div class="order-detail">
      <div class="order-card">
        ...
        <div class="click">
          <ButtonFlashBox :buttonText="'確認訂購'" :buttonBottomText="'-pv-'" class="kkss"  @click="checkLoginState(), checkOrder()"></ButtonFlashBox>
        </div>
...
<script src="@/views/js/orderProcessVenus.js"></script>
